...
export class PaymentThirdPartyConfig {
    ...
    public static fromEnv(): PaymentThirdPartyConfig {
        const config = new PaymentThirdPartyConfig();
...
export const DATABASE_CONFIG_TOKEN = token<PaymentThirdPartyConfig>("DatabaseConfig");