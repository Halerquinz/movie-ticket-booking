...
export async function seed(knex: Knex): Promise<void> {
    const exists = await knex(TabNameMovieServiceScreenType).first();
    if (!exists) {
        ...
        console.log("Screen Type Seeding initialization finish");
    } else {
        console.log("Screen Type Seeding skipped: data already exists.");
    }
};