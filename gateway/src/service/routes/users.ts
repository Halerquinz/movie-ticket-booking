...
import { AUTH_MIDDLEWARE_FACTORY_TOKEN, AuthMiddlewareFactory } from "../utils";
...
injected(getUsersRouter, USER_MANAGEMENT_OPERATOR_TOKEN, AUTH_MIDDLEWARE_FACTORY_TOKEN);
